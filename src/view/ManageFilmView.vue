    ...
    <div class="pt-22.25 p-6 grid gap-6">
        ...
        <Card class="border-primary/40">
            <CardContent class="grid sm:grid-cols-3 xl:grid-cols-6 gap-4 text-center">
                <Card @-click="handleManageFilm(items)" v-for="items in film" :key="items.id" class="border-primary/40 p-0 hover:bg-primary/20 group">
                        ...
                        <div class="flex flex-col">
                            <div class="relative">
                                <img 
                                    ...
                                    class="rounded-xl aspect-ratio rounded-br-none"
                                />
                                <div class="absolute top-0 right-0 p-1 bg-card rounded-bl-xl rounded-tr-xl">
                                    <Settings
                                        class="transition sm:flex group-hover:text-primary"
                                    />
                                </div>
...
import { RefreshCw, ChevronLeft, Plus, Minus, Settings } from 'lucide-vue-next';
...
const handleManageFilm = (data) => {
    router.push({
        path: '/manage-detail-film',
        query: { id: data.id }
    })
}
